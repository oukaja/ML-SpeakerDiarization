...
import numpy
import sklearn.svm
from speaker.utils.utils import normalize_features
EPS = numpy.finfo(float).eps


def vad(short_term_features, st_step=0.05, smooth_window=0.5, weight=0.5):
    """
    Entrée d'une partie de l'audio, section de la liste des segments de sortie intervalles vocaux
...
def train_svm(features, cparam):
    """
    Vad helper fonction pour générer un SVM pour juger s'il y a du son
    """
