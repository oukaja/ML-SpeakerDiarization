"""
Ensemble de fonction d'extraction de Caractéristiques
"""
import numpy
...
def mt_feature_extraction(signal, fs, mt_win, mt_step, st_win):
    """
     mid-term feature short-term feature
    :param signal
    :param fs
    :param mtWin: mid-term
    :param mtStep: mid-term
    :param stWin: short-term
    :param stStep: short-term
...
def st_feature_extraction(signal, fs, win, step):
    ...
    :param signal
    :param fs
    :param win: short-term
    :param step: short-term
...
def st_energy_entropy(frame, num_of_short_blocks=10):
    """
    Entropie énergétique à court terme
    """
...
def st_spectral_centroid_and_spread(cur_pos_signal, fs):
    """
    Vitesse spectrale à court terme
    """
...
def st_spectral_entropy(cur_pos_signal, num_of_short_blocks=10):
    """
    Entropie spectrale à court terme
    """
...
def st_pectral_roll_off(cur_pos_signal, cen, fs):
    """
    Rouleau spectral à court terme
    """
...
def mfcc_init_filter_banks(fs, nfft):
    """
    mfcc Largeur de filtre initiale
    """
    lowfreq = 133.33
    linsc = 200 / 3.
    logsc = 1.0711703
